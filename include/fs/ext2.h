...
ssize_t ext2_readi(void *inode, void *buf, size_t count, off_t *off);
ssize_t ext2_write(struct file *file, void *buf, size_t count);
...
int ext2_lchown(const char *path, uid_t uid, gid_t gid);
